...
def seleccionar_archivos():
    iniciar = tk.Tk() 
    iniciar.withdraw() #oculta la ventana

    entrada = filedialog.askopenfilename(
        title = "Selecciona un archivo de entrada",
        filetypes = [("Archivos de texto", "*.txt")] #solo se muestran archivos de texto txt
    )
    ...
    try:
        ...
        print("El archivo ha sido normalizado correctamente.")
